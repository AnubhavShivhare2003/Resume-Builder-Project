...
const fetchAllResumes=async()=>{
 ...
 useEffect(()=>{
    ...
    return  <DashboardLayout>
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4 md:gap-1 pt-1 b-6 px-4 md:px-0">
                <div
                className="h-[300px] flex flex-col gap-5 items-center justify-center bg-white rounded-lg border border-purple-100 hover:border-purple-300 hover:pg-pruple-50/5 cursor-pointer "
