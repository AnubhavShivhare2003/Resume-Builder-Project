...
const ProfilePhotoSelector=({image,setImage, preview, setPreview })=>{
    ...
    // Update previewUrl when preview prop changes (for loading existing images)
    useEffect(() => {
        if (preview && !image) {
  ...
  // Check if we have an image to display (either file or URL)
  const hasImage = image || preview || previewUrl;
